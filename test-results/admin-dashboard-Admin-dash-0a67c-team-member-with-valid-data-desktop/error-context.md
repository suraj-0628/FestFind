...
Locator: getByText('maintainer_1783978146727@test.example.com').or(getByText('Test Maintainer'))
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('maintainer_1783978146727@test.example.com').or(getByText('Test Maintainer'))
...
- main:
  ...
  - textbox "Email": maintainer_1783978146727@test.example.com
